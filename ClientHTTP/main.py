...
class SimpleBrowser(QMainWindow):
    ...
    def load_bookmarks(self):
        try:
            with open("files/bookmarks.txt", "r") as file:
    ...
    def save_bookmarks(self):
        with open("files/bookmarks.txt", "w") as file:
            for bookmark in self.bookmarks:
    ...
    def load_search_engine(self):
        try:
            with open("files/search_engine.txt", "r") as file:
    ...
    def save_search_engine(self):
        ...
        with open("files/search_engine.txt", "w") as file:
    ...
    def load_history(self):
        try:
            with open("files/history.txt", "r") as file:
                for line in file.readlines():
    ...
    def save_history(self):
        with open("files/history.txt", "w") as file:
